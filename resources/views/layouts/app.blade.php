                  ...
                  data:{
                    ...
                    success: function (response) { 
                       ...
                       if(response !== ''){
                           ...
                           html2+='<div class="readall read-more'+key+'" style= display:none><div><b>Share Document ID</b>:'+value.share_documents_id+'</div>'+'<div><b>IP Address</b>:'+value.ip_address+'</div>'+'<div><b>Browser Details</b>:'+value.browser+'</div>'+'<div><b>device</b>:'+value.device+ '</div>'+'</div>';
                         });
