...
<body>
	<div class="main-div">
		<header class="header-top">
			<a class="logo" href=""><img src="{{url('/')}}/dist/img/prodata.svg" alt="logo"/></a><section><input placeholder="Search Here..." type="text"/><span><a href=""><i class="fas fa-address-book"></i></a><a href=""><i class="fas fa-bell"></i></a></span></section>
		</header>
